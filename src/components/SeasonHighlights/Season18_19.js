        ...
        return (
            <div>
                  ...
                  <article class="video">
                        ...
                        <img class="videoThumb" src={vid5}></img></a>
                        </figure>
                        <h2>Titanic Rally</h2>
                  ...
                  <article class="video">
                        ...
                        <img class="videoThumb" src={vid6}></img></a>
                        </figure>
                        <h2>Racketgate</h2>
                  ...
                  <article class="video">
                        ...
                        <img class="videoThumb" src={vid4}></img></a>
                        </figure>
                        <h2>Sad Brumbies</h2>
                  ...
                  <article class="video">
                        ...
                        <img class="videoThumb" src={vid3}></img></a>
                        </figure>
                        <h2>Watergate</h2>
                        <p>Otters V Mangos. This is to remind fans of Watergate, a much more horrific and well known situation than 'Watergate' during Nixons administration. Unfortunately this is not actual footage of Watergate.</p>
                  </article>

                  <article class="video">
                        <figure>
                        <a class="fancybox fancybox.iframe" href={EsamPackersFinal}>
                        <img class="videoThumb" src={vid2}></img></a>
                        </figure>
                        <h2>Build up</h2>
                        <p>Build up to the Esam v Packers playoff semi-final.</p>
                  </article>

                  <article class="video">
                        <figure>
                        <a class="fancybox fancybox.iframe" href={PackersBrumbies}>
                        <img class="videoThumb" src={vid1}></img></a>
                        </figure>
                  ...
                  <article class="video">
                        ...
                        <img class="videoThumb" src={vid7}></img></a>
                        </figure>
